...
1. Define core models for stats and quiet assessment.
2. Implement collectors: host, process, addon, and API middleware stats.
3. Build in-memory stats snapshot and `/api/system-stats/current`.
4. Add SQLite storage for samples and `/api/system-stats/history`.
